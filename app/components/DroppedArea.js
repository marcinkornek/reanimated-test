...
class DroppedArea extends React.Component {
  constructor(props) {
    super(props);
    ...
    this.offsetX = new Value(width / 2); // initial value X
    this.offsetY = new Value(100); // initial value Y
